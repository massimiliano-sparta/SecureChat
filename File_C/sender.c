/*
 * sender.c â€” Invia un messaggio a un gruppo multicast UDP
 *
 ...
 *
 * Reti e Sistemi Distribuiti Mod.B â€” UniversitÃ  di Messina
 */
...
int main(int argc, char *argv[])
{
    ...
    /* 1. Crea un normale socket UDP.
          Il multicast si appoggia sempre su UDP â€” non su TCP.       */
