...
Nato come progetto per il corso di Laboratorio di Reti e Sistemi Distribuiti Mod. B — Università degli Studi di Messina — poi esteso oltre i requisiti della consegna: due implementazioni equivalenti del multiplexing, un client dedicato, e la cifratura TLS del canale.
